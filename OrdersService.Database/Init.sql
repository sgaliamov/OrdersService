INSERT [dbo].[Orders] ([CreationTimestamp], [OrderId], [Price], [CustomerName], [PostCode], [Number], [Street], [City], [Country], [Phone]) VALUES 
    ...
    (CAST(N'2018-03-28T09:41:00' AS DateTimeOffset), 'SAL1003221', 2.0000, N'name 2', '2032AB', 14, N'Street', N'Amsterdam', N'The Netherlands', NULL),
    ...
    (CAST(N'2018-03-28T09:42:07' AS DateTimeOffset), 'SAL1000004', 7.0000, N'name 7', '7032AB', 19, N'Street', N'Amsterdam', N'The Netherlands', '0123456789')
GO
